...
(() => {
  ...
  document.addEventListener("click", (event) => {
    const isClickSearchBoxInside = searchElement.contains(event.target);
    if (!isClickSearchBoxInside) $(".search-result").css("display", "none");
  });
  ...
  $("#video")
    ...
    .click(function () {
      if ($(this).children("#video").get(0).paused) {
        ...
        $(this).children(".video-button").fadeOut();
      } else {
